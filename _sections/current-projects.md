...
<table border="0">
    ...
    <tr>
        <td>Multimodality improves the modeling of language, as cognitively 
            speaking language is not unimodal. How would a language model
            equipped with multiple modalities, such as fMRI data, eye-tracking
            data, and EEG data, improve upon the vanilla language model? How
            can one combine the various modalities of natural language
            effectively with the textual one? Moreover, how can one
            evaluate a language model that is equipped with these
            cognitive abilities (more specifically, provided with the data that
            is used in the human cognition of natural language)?</td>
    </tr>
</table>
...
<table border="0">
    <tr>
      <th align="center">Pregroup Representation of Hindi Syntax (2017-2021) </th>
      <th align="center">Word Embedding in Non-Euclidian Spaces (2018-2021) </th>
    </tr>
    <tr>
      <td> I was working on a computational algebraic representation of
      Hindi syntax using pregroup calculus for my master's thesis.
  ...
  <tr>
  <th>Computational Analysis of Misunderstanding (2020-2021) </th>
  <th>Probing Attention-Based Code-Mixed Data (2020)</th>
  </tr>
  <tr>
...
<table border="0">
    <tr>
      <th align="center">The Hindi TimeBank Project (2017-2020)</th>
      <th align="center">Inference over Events (2017-2020)</th>
    </tr>
    <tr>
...
<table border="0">
    <tr>
        <th> Stance Detection for MOderation Signals (2021) </th>
        <th> Aspect Based Sentiment Analysis in Hindi (2020-2021) </th>
    </tr>
    <tr>
      <td>If there is one thing that is for certain, it is that 
          statements on the internet are opinionated. They might
          not be semantically rich, or even coherent, but they are
          vocal about their stand on a variety of topics. Detecting
          the general stance of a group of people on a given topic
          is a powerful tool in analytics which can improve insight
    ...
    <tr>
        <th> Semantics of Emojis (2018-2020) </th>
        <th> Sexism on Social Media (2019) </th>
    </tr>
    <tr>
        <td> Emojis are a common part of social media text. They occur
            both in place of words and as markers for emphasis and emotion.
            However, is a method to determine the exact, or approximate
            semantic value of an emoji? Can the established methods of vector
            embeddings be scaled to, or applied to, emojis and combined
            with the existing representation for downstream NLP tasks?
            Can we design a model which can explain/explore the representation
            of emojis in comparison to other sentences?
        </td>
        ...
        which are most susceptible to be/contain sexist undertones.
        </td>
    </tr>
</table>
